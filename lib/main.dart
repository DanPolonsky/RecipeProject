...
class MyApp extends StatelessWidget {
    ...
    Widget build(BuildContext context) {
        return MaterialApp(title: 'Text-To-Speech Demo', home: InitialWaitingPage());
    }
}
...
class Home extends StatelessWidget {
    @override
    Widget build(BuildContext context) {
        return Consumer3<CategoryRecipeListProvider, LoginPageProvider, SignUpPageProvider>(
            builder: (context, provider, loginProvider, signUpProvider, child) =>
                Scaffold(
                    ...
                    body: provider.isLoading ? RecipesWaitingPage() : RecipeCardList(),
                ),
        );
    }
}
...
class RecipeCardList extends StatelessWidget {
    final List<String> _categories = ["Popular", "Meat", "BreakFast"];
                        ...
                        Align(
                            ...
                            child: Container(
                                child: SingleChildScrollView(
                                    ...
                                    child: Row(
                                        children: [
                                            for(String category in _categories) Container(
                                                margin: EdgeInsets.all(4),
                                                child: RaisedButton(
                                                    onPressed: () =>
