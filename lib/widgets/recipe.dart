...
class Recipe extends StatelessWidget {
  ...
  void callInitializeVariables(BuildContext context) async {
    var recipeProvider = Provider.of<RecipePageProvider>(context, listen: false);
    recipeProvider.initializeProviderVariables(
    ...
    recipeProvider.startListening();
    print("initialized recipe");
  ...
  Widget build(BuildContext context) {
    callInitializeVariables(context);
      ...
      builder: (context, provider, child) => Scaffold(
          appBar: AppBar(
            leading: IconButton(
                ...
                onPressed: () {
                  if (_rated) {
                    rate(_recipeInfo.id, _newRating);
                  }
